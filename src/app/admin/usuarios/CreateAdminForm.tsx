  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 text-[11px] font-semibold text-white bg-violet-600 hover:bg-violet-500 border border-violet-500/40 px-3 py-1.5 rounded-lg transition-colors"
      >
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 text-[11.5px] font-semibold text-slate-400 bg-slate-800 hover:bg-slate-700 border border-slate-700/60 py-2.5 rounded-lg transition-colors"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 text-[11.5px] font-semibold text-white bg-violet-600 hover:bg-violet-500 py-2.5 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
